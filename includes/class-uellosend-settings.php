...
class UelloSend_Settings {
    ...
    public function render_settings_page() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_POST['uellosend_sms_settings_nonce']) && wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['uellosend_sms_settings_nonce'])), 'uellosend_sms_save_settings')) {
                ...
                if (isset($_POST['sender_id']) && isset($_POST['api_url']) && isset($_POST['api_key']) && isset($_POST['admin_phone'])) {
                    ...
                    update_option('wc_sms_sender_id', sanitize_text_field(wp_unslash($_POST['sender_id'])));
                    update_option('wc_sms_api_url', esc_url_raw(wp_unslash($_POST['api_url'])));
                    update_option('wc_sms_api_key', sanitize_text_field(wp_unslash($_POST['api_key'])));
                    update_option('wc_sms_admin_phone', sanitize_text_field(wp_unslash($_POST['admin_phone'])));
        ...
        <div class="wrap">
            ...
            <img src="<?php echo esc_url(UELLOSEND_SMS_URL . 'assets/images/uvitech.jpg'); ?>" alt="UelloSend Logo" style="width:200px; height:auto; margin-bottom:20px;"/>
            ...
            <?php wp_nonce_field('uellosend_sms_save_settings', 'uellosend_sms_settings_nonce'); ?>
